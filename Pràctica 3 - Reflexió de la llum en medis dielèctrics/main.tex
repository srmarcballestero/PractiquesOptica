...
\begin{multicols}{2}
 ...
 Tenint en compte que quan l'angle d'incidència és l'angle de Brewster, l'angle de l'eix de l'analitzador és nul, per la tria d'orígens realitzada en la secció \ref{sec:BrewsterVisual}, podem calcular l'angle de Brewster a partir dels paràemtres de l'ajust lineal, segons
 \begin{equation*}
 ...
 Finalment, tenint en compte que l'angle $a$ de l'eix de l'analitzador és el seu gir respecte el pla paral·lel al d'incidència i les fórmules \eqref{eq:Fresnel}, tenim la relació teòrica
