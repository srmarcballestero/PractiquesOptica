...
\addplot[red, thick, scatter, scatter/classes={a={mark=diamond, red!80!, scale=0.5},b={mark=x,black,scale=1.2}}, scatter src=explicit symbolic] plot []table[x = x, y = I, meta=class]{Dades/Circ2 - Fil.csv};
