...
Si denotem $R_x$ i $R_y$ els valors calculats per \eqref{eq:Rx} i \eqref{eq:Ry}, respectivament; obtenim que $R_x = \SI{0.557(4)}{\milli\metre}$ i $R_y = \SI{0.553(4)}{\milli\metre}$, que són clarament compatibles. S'estima, doncs, el radi de l'escletxa com la mitjana aritmètica  d'aquests valors junt amb la corresponent incertesa propagada, d'on $R = \SI{0.555(3)}{\milli\metre}$.

\input{Figures/Circ1 - XY}
...
En conseqüència, s'obté que els  $L_x = \SI{0.447(4)}{\milli\metre}$, $L_y = \SI{2.529(4)}{\milli\metre}$ i $D = \SI{0.3549(12)}{\milli\metre}$.
