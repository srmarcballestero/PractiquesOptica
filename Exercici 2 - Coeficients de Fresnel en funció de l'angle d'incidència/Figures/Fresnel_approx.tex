...
\captionof{figure}{(\textsc{A}) Aproximació dels coeficients de Fresnel per la mitjana i (\textsc{B}) error relatiu associat a cada aproximació.}
\label{fig:Fresnel_approx}
\end{figure}
