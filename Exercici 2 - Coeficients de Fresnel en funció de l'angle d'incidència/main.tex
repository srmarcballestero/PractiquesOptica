...
En la figura \ref{fig:Fresnel_coeffs} es representen els valors obtinguts dels coeficients de Fresnel en funció de l'angle d'incidència. Notem que per a incidència normal ($\varphi = \SI{0}{\degree}$), tenim que
