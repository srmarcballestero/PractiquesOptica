...
\end{equation}
on $n \in \mathbb{N}$ és el nombre de màxims que apareixen o desapareixen pel centre de la imatge.
...
Incorporant com a font del sistema òptic un làser díode expandit amb una lent, s'ha obtingut que, entre $D_1 = \SI{4.320(5)}{\milli\metre}$ i $D_2 = \SI{4.230(5)}{\milli\metre}$ apareixen\footnote{En la secció \ref{sec:errors} es discuteix tot allò relatiu a la incertesa en el nombre d'anells $\delta n$.} $n = \num{55(2)}$ anells d'interferència. L'error en les distàncies s'ha près com la meitat de la resolució de l'escala del micròmetre.
...
\begin{itemize} [label = --]
 \item \textbf{Mesura 1}. S'ha obtingut que entre $D_1 = \SI{6.720(5)}{\milli\metre}$ i $D_2 = \SI{6.800(5)}{\milli\metre}$ desapereixien\footnote{El signe negatiu de $n$ es deu al fet que els anells desapareixen pel centre de la imatge.} $n = \num{-54(2)}$ anells, per tant, aplicant \eqref{eq:lambda} s'obté que $\lambda_{\textup{Na},1} = \SI{590 \pm 60}{\nano\metre}$.
