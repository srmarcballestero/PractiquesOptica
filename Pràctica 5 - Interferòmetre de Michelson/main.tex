...
Finalment, la separació del doblet del sodi s'ha estimat com la mitjana entre els dos valors, calculada segons \eqref{est:mitjana}, obtenint que $\Delta \lambda_\textup{Na,av} = \SI{0.51(5)}{\nano\metre}$, que és compatible amb la provinent dels valors de la bibliografia $\Delta \lambda_\textup{Na} = \SI{0.6}{\nano\metre}$, ja que
\begin{equation*}
