...
\begin{tikzpicture}[scale=0.85]
    ...
    \addplot[samples=200,domain=-5:365, color=red, very thick] {3.46};
    \addplot[samples=200,domain=-5:365, color=red, thick, dashed] {3.46+0.27};
    \addplot[samples=200,domain=-5:365, color=red, thick, dashed] {3.46-0.27};
    ...
    \addplot[scatter, only marks, scatter/classes={a={mark=*, red, scale=0.65}, b={mark=*, green, scale=0.65}}, scatter src=explicit symbolic
    ...
    \end{axis}
\end{tikzpicture}
\captionof{figure}{Intensitat detectada pel díode en funció de l'angle de l'escala de l'analitzador, amb la relació teòrica de la llei de Malus superposada.}
