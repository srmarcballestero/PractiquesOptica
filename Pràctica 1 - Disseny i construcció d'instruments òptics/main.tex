...
\end{equation}
i obtenim que $s'_\textup{obj} = \SI{87 \pm 10}{\centi\metre}$. Així doncs, la distància entre l'objectiu i l'ocular ve donada per $d_{\textup{obj} \rightarrow \textup{dia}} = s'_\textup{obj} + f'_\textup{ocu} = \SI{92 \pm 10}{\centi\metre}$, valor compatible amb l'obtingut amb la cinta mètrica.
