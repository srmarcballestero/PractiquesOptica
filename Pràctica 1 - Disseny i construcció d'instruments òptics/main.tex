...
\end{equation}
i val $t = \SI{66.9 \pm 0.1}{\centi\metre}$.

Ara, ens proposem calcular l'augment angular del microscopi $\Gamma'$. Per fer-ho, primer calculem l'agument lateral de l'objectiu, segons
...
\end{equation}
i obtenim que $\beta'_\textup{obj} = -6.37 \pm 0.18$. Així mateix, calculem l'augment angular de l'ocular segons \eqref{eq:augmentull} i obtenim $\Gamma'_\textup{ocu} = 5.1 \pm 0.7$. Conegudes aquestes dades, podem expressar l'augment angular total del sistema com
...
\end{equation}
que resulta $\Gamma' = 32 \pm 5$.

L'emergència de la pupil·la de sortida vindrà donada per \eqref{eq:pupilasortida} i val $e = \SI{}{\centi\metre}$.
